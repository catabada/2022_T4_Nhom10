...
public class ConnectFTPServer {
    ...
    public ConnectFTPServer(String ip, int port, String username, String password) {
        this.ip = ip;
        this.port = port;
    ...
    public static void main(String[] args) {
        ConnectFTPServer connectFTPServer = new ConnectFTPServer("103.97.126.30", 21, "huynhhuuan@huuan.tk", "12345678");
        connectFTPServer.connect();
        connectFTPServer.sendFileToFtpServer("1665665628178.csv");
